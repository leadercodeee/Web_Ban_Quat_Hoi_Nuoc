...
<div class="container">
    ...
    <div class="leadership-section">
        <div class="leader">
            <img src="http://localhost:63342/LTW/template/images/person_2.jpg" alt="CEO">
            <h3>Trần Hoài Nam</h3>
            <p>Giám đốc điều hành</p>
            <p>Lãnh đạo chiến lược và phát triển tổng thể của công ty.</p>
        </div>
        <div class="leader">
            <img src="http://localhost:63342/LTW/template/images/person_1.jpg" alt="CTO">
            <h3>Hoàng Nhựt Duy</h3>
            <p>Giám đốc công nghệ</p>
            <p>Định hướng công nghệ và dẫn dắt đội phát triển.</p>
        </div>
        <div class="leader">
            <img src="http://localhost:63342/LTW/template/images/person_3.jpg" alt="CFO">
            <h3>Nguyễn Phong</h3>
            <p>Giám đốc tài chính</p>
            <p>Quản lý tài chính và đảm bảo sự phát triển bền vững.</p>
        </div>
